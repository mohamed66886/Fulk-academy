        ...
        <PopoverTrigger asChild>
          <button
            className={cn(
              ...
              !date && "text-gray-500",
              error &&
                "bg-red-50/50 text-red-600 border-red-300 focus:ring-red-100 hover:border-red-400",
              ...
              <div
                className={cn(
                  ...
                  date
                    ...
                    : "bg-gray-100 text-gray-500 group-hover:bg-primary/5 group-hover:text-primary/70",
